// src/utils/is.ts
var is = {
  pseudoSelector: (selector) => selector.startsWith(":"),
  mediaQuery: (property) => property.startsWith("@media"),
  directClass: (property, _) => property === ".",
  cssVariables: (property, _) => property === "--",
  validProperty: (value) => typeof value === "string" || typeof value === "number",
  ...
  function create(styles) {
    ...
    forIn(styles, (scopeName, styles2) => {
      if (is.topLevelClass(scopeName, styles2)) {
        const scopeClassName2 = stableHash(sheet.name, scopeName);
